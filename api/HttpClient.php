...
use grandmasterx\safecharge\api\exceptions\ResponseException;
use grandmasterx\safecharge\api\interfaces\HttpClientInterface;
use grandmasterx\safecharge\api\exceptions\SafeChargeException;
...
class HttpClient implements HttpClientInterface
{
    ...
    protected function handleResultError($result, $logger) {
        ...
        if (isset($decodedResult['errCode']) && !empty($decodedResult['errCode'])) {
            ...
            $logger->error(
                "[SafeCharge PHP SDK] " .
                $decodedResult['gwErrorCode']
                . ': ' . $decodedResult['gwErrorReason']
            );
            throw new ResponseException(
                $decodedResult['gwErrorReason'],
                $decodedResult['gwErrorCode'],
